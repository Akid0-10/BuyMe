...
// Display the admin's information to update
...
if (isset($_POST["btnUpdateUser"])) {
    ...
    $update_admin = "UPDATE admin SET password = '$password_crypt WHERE username = '$username''";
...
<body>
    ...
    <script>
        ...
        function back() {
            ...
            document.location.href = "user-profile-admin.php";
        }
